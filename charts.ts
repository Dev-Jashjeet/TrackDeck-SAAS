...
// weekly chart update
let weekly:chartI = {labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
              data: [200,300,450,400,600,1000],
...
(function loadChart(): void {
  v.data.labels = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  v.data.datasets[0].data = [200,300,450,400,600,1000];
  v.update();
